...
- Issue histórica migrada: [#46](https://github.com/Aneety/.github/issues/46)
...
| --- | --- | --- | --- | --- | --- | --- |
| `repositorio` | `pronto` | alta | `arquitetura` | [Issue histórica #46](https://github.com/Aneety/.github/issues/46) | — | Criar ou revisar estrutura inicial em `Aneety/ai` quando este ciclo começar. |
...
- 2026-05-29 — bloqueio antigo ligado ao painel externo deixa de ser impeditivo; status `repositorio` volta para `pronto` neste modelo.
