...
- Responsabilidade: `demo-seeds`
- Owner: Ricardo Malnati
- Repo destino: `Aneety/ai`
- Caminho canônico: `aneety-platform/apps/demo-seeds/...`
- Issue histórica migrada: [#26](https://github.com/Aneety/.github/issues/26)
...
| --- | --- | --- | --- | --- | --- | --- |
| `repositorio` | `pronto` | media | `arquitetura` | [Issue histórica #26](https://github.com/Aneety/.github/issues/26) | — | Criar ou revisar estrutura inicial em `Aneety/ai` quando este ciclo começar. |
