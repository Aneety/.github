...
- Responsabilidade: `offline-sync`
- Owner: Ricardo Malnati
- Repo destino: `Aneety/ai`
- Caminho canônico: `aneety-platform/apps/offline-sync/...`
- Issue histórica migrada: [#14](https://github.com/Aneety/.github/issues/14)
...
| --- | --- | --- | --- | --- | --- | --- |
| `repositorio` | `bloqueado` | media | `arquitetura` | [Issue histórica #14](https://github.com/Aneety/.github/issues/14); inspeção local 2026-05-30 confirmou que `Aneety/ai` ainda contém apenas `aneety-platform/apps/.gitkeep`. | Falta raiz `aneety-platform/apps/offline-sync/...` em `Aneety/ai`; monorepo segue sem raiz concreta da responsabilidade além de `aneety-platform/apps/.gitkeep`. | Criar raiz canônica da responsabilidade em `Aneety/ai` antes de avançar para `deploy`. |
