...
| --- | --- | --- | --- | --- | --- | --- |
| `repositorio` | `pronto` | media | `arquitetura` | [Issue histórica #24](https://github.com/Aneety/.github/issues/24) | — | Criar ou revisar estrutura inicial em `Aneety/ai` quando este ciclo começar. |
