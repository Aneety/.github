...
| --- | --- | --- | --- | --- | --- | --- |
| `repositorio` | `pronto` | alta | `arquitetura` | [Issue histórica #7](https://github.com/Aneety/.github/issues/7) | — | Criar ou revisar estrutura inicial em `Aneety/ai` quando este ciclo começar. |
